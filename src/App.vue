...
<template>
    <header class="bg-zinc-800 p-4 h-16 text-zinc-100">
        <div class="flex justify-between items-center mx-auto container">
            ...
            <nav :class="{ 'hidden': !isMenuOpen }" class="lg:block lg:relative absolute">
                <ul class="flex lg:flex-row flex-col lg:space-x-4 space-y-2 lg:space-y-0">
                    <li><a href="/#sluzby" class="hover:text-yellow-400">Služby</a></li>
                    <li><a href="/rezervace" class="hover:text-yellow-400">Poptávka</a></li>
                    <li><a href="/#cenik" class="hover:text-yellow-400">Ceník</a></li>
                    <li><a href="/obchodni-podminky"
                            class="hover:text-yellow-400">Obchodní&nbsp;podmínky</a></li>
                </ul>
            </nav>
        </div>
    </header>
