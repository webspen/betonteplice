                ...
                <FormKit :type="('multi-step' as any)" tab-style="progress">
                    <FormKit :type="('step' as any)" name="reservation" label="Rezervace"
                        nextLabel="Pokračovat">
                            <label for="date"
                                class="block mb-2.5 font-medium text-gray-700 text-lg dark:text-gray-300">Datum&nbsp;rezervace</label>
                    ...
                    <FormKit :type="('step' as any)" name="subject" label="Subjekt"
                        previousLabel="Zpět" nextLabel="Pokračovat">
                            ...
                            <FormKit v-if="['podnikatel', 'pravnicka'].includes(form.customer_type)"
                                type="text" label="IČO" name="ico" min="8" max="8"
                                validation="required|number" />
                            <FormKit v-if="form.customer_type !== 'baracnik'" type="checkbox"
                                label="Plátce DPH" field="customer_vat" />
                            <FormKit v-if="(form.customer_type !== 'baracnik') && form.customer_vat"
                                type="text" label="DIČ" name="dic" min="8" max="12" />
                            <FormKit type="text" name="jmeno" v-model="form.customer_name"
                                :label="form.customer_type === 'pravnicka' ? 'Obchodní Jméno' : 'Jméno a Příjmení'"
                    ...
                    <FormKit :type="('step' as any)" name="address" label="Adresa"
                        previousLabel="Zpět" nextLabel="Pokračovat">
                            ...
                            <FormKit v-if="form.address_type === 'existujici'" type="search"
                                label="Adresa" name="adresa" placeholder="Vyhledat adresu..."
                                validation="required" />
                            <FormKit v-else-if="form.address_type === 'pozemek'" type="text"
                                help="Nejbližší existující adresa" name="pozemek"
                                placeholder="Číslo pozemku" validation="required" />
                            <FormKit type="text" :value="form.address_zip" name="psc" label="PSČ"
